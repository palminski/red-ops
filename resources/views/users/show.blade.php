                    ...
                    <div class=" flex justify-between">
                        <div>
                            ...
                            @if (Auth::user() && Auth::user()->id == $user->id)
                                <form x-show="showProfileImageUpload"
                                    action="{{ route('users.picture.update', ['id' => Auth::user()->id]) }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div>
                                        <input
                                            class="file:bg-zinc-900 file:text-white file:px-2 file:border file:border-zinc-300 cursor-pointer"
                    ...
                    @if ($user->achievements->count() > 0)
                        <div>
                            <div class="flex justify-between">
                                ...
                                <button x-on:click="showAchievement=!showAchievement"
